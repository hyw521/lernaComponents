...
const Export = (props) => {
    const { replaceElement, text = "导出", url, methods = "a", fileName, isNewWindow = true, } = props;
    ...
    return (React.createElement(React.Fragment, null,
        ...
        !replaceElement && (React.createElement(Button, { type: "primary", loading: loading, onClick: handleDownload }, text))));
};
